...
<Preview
  data = {`<p class="tdl-none t-l-gray-2">No Text Decoration</p>`}
  usePadding
  useCenter
  useVersion = '1.2.0'
/>
...
<Preview
  data = {`<p class="tdl-u t-l-gray-2">Underline</p>`}
  usePadding
  useCenter
  useVersion = '1.2.0'
/>
...
<Preview
  data = {`<p class="tdl-o t-l-gray-2">Overline</p>`}
  usePadding
  useCenter
  useVersion = '1.2.0'
/>
...
<Preview
  data = {`<p class="tdl-lt t-l-gray-2">Line Through</p>`}
  usePadding
  useCenter
  useVersion = '1.2.0'
/>