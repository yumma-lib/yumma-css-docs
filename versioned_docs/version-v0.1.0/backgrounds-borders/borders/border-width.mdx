...
<Preview
  data = {`<div class="bc-pink h-8 w-8"></div>`}
  usePadding
  useCenter
  useVersion = '0.0.1'
/>
...
<Preview
  data = {`<div class="bb-2 bc-pink h-8 w-8"></div>`}
  usePadding
  useCenter
  useVersion = '0.0.1'
/>
...
<Preview
  data = {`<div class="bc-pink bl-2 h-8 w-8"></div>`}
  usePadding
  useCenter
  useVersion = '0.0.1'
/>
...
<Preview
  data = {`<div class="bc-pink br-2 h-8 w-8"></div>`}
  usePadding
  useCenter
  useVersion = '0.0.1'
/>
...
<Preview
  data = {`<div class="bc-pink bt-2 h-8 w-8"></div>`}
  usePadding
  useCenter
  useVersion = '0.0.1'
/>