...
<Preview
  data = {`<div class="bb-2 bc-pink dim-14"></div>`}
  usePadding
  useCenter
  useVersion = '2.0.0'
/>
...
<Preview
  data = {`<div class="bc-pink bl-2 dim-14"></div>`}
  usePadding
  useCenter
  useVersion = '2.0.0'
/>
...
<Preview
  data = {`<div class="bc-pink br-2 dim-14"></div>`}
  usePadding
  useCenter
  useVersion = '2.0.0'
/>
...
<Preview
  data = {`<div class="bc-pink bt-2 dim-14"></div>`}
  usePadding
  useCenter
  useVersion = '2.0.0'
/>
