...
export default function CommandPaletteBase({
  ...
  const triggerClasses = merge(
    "bg-white d-f ai-c g-2 px-3 py-2 bc-silver-2 c-slate-10 bw-1 fw-500 tp-c tdu-150 ttf-io us-none fv:os-s fv:ow-3 fv:oo-0 fv:oc-indigo-2/60 fv:bc-indigo-3",
    ITEM_SHAPES[shape],
    className,
  );
