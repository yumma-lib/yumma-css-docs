...
export const registryTargets: Record<string, RegistryTarget> = {
  ...
  "autocomplete-loading": { component: "autocomplete", variant: "loading", kind: "block", install: "autocomplete-loading" },
  "autocomplete": { component: "autocomplete", variant: "base", kind: "component", install: "autocomplete" },
  "avatar-detailed": { component: "avatar", variant: "detailed", kind: "example", install: "avatar" },
  "avatar-edit": { component: "avatar", variant: "edit", kind: "block", install: "avatar-edit" },
  ...
  "avatar-stack-compact": { component: "avatar", variant: "stack-compact", kind: "example", install: "avatar" },
  "avatar-stacked": { component: "avatar", variant: "stacked", kind: "block", install: "avatar-stacked" },
  ...
  "button-favorite": { component: "button", variant: "favorite", kind: "example", install: "button" },
  "button-group-icon": { component: "button", variant: "group-icon", kind: "block", install: "button-group-icon" },
  "button-group-pill-label": { component: "button", variant: "group-pill-label", kind: "block", install: "button-group-pill-label" },
  "button-group-pill": { component: "button", variant: "group-pill", kind: "block", install: "button-group-pill" },
  "button-group": { component: "button", variant: "group", kind: "block", install: "button-group" },
  "button": { component: "button", variant: "base", kind: "component", install: "button" },
  "checkbox-group-label": { component: "checkbox", variant: "group-label", kind: "block", install: "checkbox-group-label" },
  "checkbox-group-nested-parent": { component: "checkbox", variant: "group-nested-parent", kind: "block", install: "checkbox-group-nested-parent" },
  "checkbox-parent": { component: "checkbox", variant: "parent", kind: "block", install: "checkbox-parent" },
  ...
  "dialog-edit-profile": { component: "dialog", variant: "edit-profile", kind: "block", install: "dialog-edit-profile" },
  "dialog-nested": { component: "dialog", variant: "nested", kind: "block", install: "dialog-nested" },
  "dialog-send-invite": { component: "dialog", variant: "send-invite", kind: "block", install: "dialog-send-invite" },
  "dialog-share-task": { component: "dialog", variant: "share-task", kind: "block", install: "dialog-share-task" },
  "dialog-sign-up": { component: "dialog", variant: "sign-up", kind: "block", install: "dialog-sign-up" },
  ...
  "field-button": { component: "field", variant: "button", kind: "block", install: "field-button" },
  "field-password": { component: "field", variant: "password", kind: "block", install: "field-password" },
  ...
  "onboarding-checklist": { component: "onboarding", variant: "checklist", kind: "example", install: "onboarding" },
  "onboarding-pagination": { component: "onboarding", variant: "pagination", kind: "example", install: "onboarding" },
  "onboarding": { component: "onboarding", variant: "base", kind: "component", install: "onboarding" },
  "popover-color-palette": { component: "popover", variant: "color-palette", kind: "block", install: "popover-color-palette" },
  "popover": { component: "popover", variant: "base", kind: "component", install: "popover" },
  "preview-card-compact": { component: "preview-card", variant: "compact", kind: "block", install: "preview-card-compact" },
  "preview-card-multiple": { component: "preview-card", variant: "multiple", kind: "block", install: "preview-card-multiple" },
  "preview-card-project": { component: "preview-card", variant: "project", kind: "example", install: "preview-card" },
  ...
  "rating-emoji": { component: "rating", variant: "emoji", kind: "example", install: "rating" },
  "rating-feedback": { component: "rating", variant: "feedback", kind: "block", install: "rating-feedback" },
  ...
  "toggle-color-picker": { component: "toggle", variant: "color-picker", kind: "block", install: "toggle-color-picker" },
  "toggle-group": { component: "toggle", variant: "group", kind: "block", install: "toggle-group" },
  "toggle": { component: "toggle", variant: "base", kind: "component", install: "toggle" },
  "toolbar-input": { component: "toolbar", variant: "input", kind: "example", install: "toolbar" },
