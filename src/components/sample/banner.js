...
<div class="dir-b-0 dir-r-0 mx-auto p-6 p-f sm:max-w-100 w-full z-60">
  <div class="bg-white bs-sm p-4 rad-2">
    <div class="cg-5 d-f">
      <div class="fg-1">
        <h2 class="fs-lg fw-600 t-d-gray-4">
          We are using cookies to improve your experience!
        </h2>
        <p class="fs-sm mt-2 t-d-gray-1">By clicking "Allow all", you agree to use of all cookies. Visit our
