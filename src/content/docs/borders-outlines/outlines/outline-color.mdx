...
import { base } from "../../../../constants/examples/outline-color";
...
Using `:hover` variants such as `h:oc-*` allows you to override elements and change their values when hovering over them.

```html "h:oc-pink"
<div class="oc-lead h:oc-pink ..."></div>
```
