...
date: 2024-01-24
excerpt: This update isn't going to introduce any major new features. It's more about syntax changes. Anyway, here it is — [Yumma CSS v1.1.0](https://github.com/yumma-lib/yumma-css/releases/tag/v1.1.0).
pagefind: false
