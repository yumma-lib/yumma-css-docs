...
cover:
  alt: Yumma CSS
  image: /src/assets/releases/yummacss-2.0.0/cover.png
date: 2024-07-03
draft: true
excerpt: Yup, it's happening again! Today, I'm super jazzed to announce [Yumma CSS v2.0.0](https://github.com/yumma-lib/yumma-css/releases/tag/v2.0.0). This new update is packed with an extensive set of new utilities, major improvements, redesigned source code and of course some important fixes.
pagefind: false
slug: blog/yummacss-2.0.0
...
Also, I'm also introducing a new color option in the color Palette — The Silver Color.
...
You can now change the color of SVG elements with Yumma CSS 2.0 using the new **Fill** color utilities.
...
The **Gap** utilities aren't necessarily new, but they are different, in older versions **Gap** were intended strictly for responsive layouts and not for adding gaps between elements. In Yumma CSS v2.0 this won't be the case anymore.
...
Took me long enough, but I’m finally adding full media query support for every single utility class.
