...
![Yumma CSS Cover](/src/assets/releases/yummacss-1.2.0/cover.png)
...
<Preview
  data = {`<p class="lh-6 t-l-gray-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Justo laoreet sit amet cursus sit amet dictum sit amet. Ultrices eros in cursus turpis. Nec feugiat in fermentum posuere urna nec tincidunt praesent. Nulla malesuada pellentesque elit eget gravida cum.</p>`}
  useHeight = '160px'
  usePadding
  useVersion = '1.2.0'
/>
