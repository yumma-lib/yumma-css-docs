...
:::note
To get Yumma CSS Intellisense up and running, you'll need to add `yummacss` as a dependency in your project. Learn how about Yumma CSS Integrations [here](/docs/installation)
