...
:::note
To get Yumma CSS Intellisense up and running, you'll need to add `yummacss` as a dependency in your project. Find out more about [Yumma CSS Integrations](/docs/installation).
