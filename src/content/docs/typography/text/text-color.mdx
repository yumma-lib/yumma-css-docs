...
<Preview
  data = {`<h3 class="tc-pink">The quick brown fox jumps over the lazy dog.</h3>`}
  usePadding
  useCenter
  useVersion = 'release'
/>
...
<Hover>Hover to see the text change.</Hover>

Use `h:tc-*` to modify elements to override other background classes.

<Preview
  data = {`<h3 class="tc-gray h:tc-pink">The quick brown fox jumps over the lazy dog.</h3>`}
  usePadding
  useCenter
  useVersion = 'release'
/>