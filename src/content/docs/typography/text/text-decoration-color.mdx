...
The `:hover` variant, such as `h:tdc-*`, allows you to modify text decoration colors when hovering over elements.

```html "h:tdc-pink"
<p class="tdc-lead h:tdc-pink ...">The quick brown fox jumps over the lazy dog.</p>
```
