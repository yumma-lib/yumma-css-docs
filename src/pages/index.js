        ...
        <Layout>
            <div className="mx-2">
                <main style={{ maxWidth: '56rem' }} className="d-f fd-c jc-c lg:mb-10 lg:mt-8 mb-6 mt-4 mr-auto ml-auto ta-c">
                    ...
                    <p className="as-c fs-2xl t-lead lh-3 max-w-100 md:max-w-full ta-c">Packaged with components and utility classes to get your applications into production.</p>
