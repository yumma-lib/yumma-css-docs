            ...
            <div className="mx-2">
                <main style={{ maxWidth: '56rem' }} className="d-f fd-c jc-c lg:mb-30 lg:mt-24 mb-18 mt-12 mr-auto ml-auto ta-c">
                    ...
                    <section className="as-c d-f fd-c mt-6 sm:fd-r sm:w-auto">
                        <Link className="ai-c bg-pink h:t-white d-if fs-md fw-700 jc-c lh-3 px-3 py-3 rad-8 sm:px-6 sm:w-auto t-white w-full" to="/docs/installation">Get started</Link>
                    </section>
                </main>
            </div>
        </Layout>
