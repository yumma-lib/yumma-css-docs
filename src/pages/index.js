            ...
            <div class="mx-2">
                <main style={{ maxWidth: '56rem' }} class="d-f fd-c jc-c lg:mb-30 lg:mt-24 mb-18 mt-12 mx-auto ta-c">
                    ...
                    <section class="as-c d-f fd-c mt-6 sm:fd-r sm:w-auto">
                        <Link style={{ textDecoration: 'none' }} class="ai-c bg-pink d-if fs-sm fw-700 h:bg-d-pink-1 h:t-white jc-c lh-3 px-3 py-3 rad-2 sm:px-6 sm:w-auto t-white w-full" to="/docs/installation">Get started</Link>
                    </section>
                </main>
            </div>
        </Layout>
