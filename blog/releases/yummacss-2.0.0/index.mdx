...
- [x] **[All new utilities](#all-new-utilities):** Color utilities, Gap, Spacing, and much more

- [x] **[Base styles](#base-styles):** Base styles is now optional

- [x] **[Responsive breakpoints](#responsive-breakpoints):** Media query utilities support extended

- [x] **[Container rules](#container-rules):** New container utility rules
