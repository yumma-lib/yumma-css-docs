...
The **Gap** utilities aren't necessarily new, but they are different, in older versions [Offset Gap](/docs/1.2.0/responsive-design#offset-gap) were intended strictly for responsive layouts and not for adding gaps between elements. In Yumma CSS v2.0 this won't be the case anymore.
