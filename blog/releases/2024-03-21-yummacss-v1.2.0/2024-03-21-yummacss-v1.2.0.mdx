...
If you would like to see a more fine-grained, but also more detailed list, you can take a look at the [release notes](https://github.com/yumma-lib/yumma-css/releases/tag/v1.2.0).
